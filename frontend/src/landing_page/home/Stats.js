        ...
        <div className='contaier p-3'>
            <div className='row p-5'>
                <div className='col-6 p-5'>
                    ...
                    <p className='text-muted'>That's why 1.3+cr coustumer trust Zerodha with $3.5+ lakh crores worth of equity investments.</p>
                    <h2 className='fs-4'>No spam of gimmicks</h2>
                    <p className='text-muted'>No gimmicks, spam,"gamification",or annoying push notifications. High quality apps that you use at your pace, the way you like.</p>
                    <h2 className='fs-4'>The Zerodha universe</h2>
                    <p className='text-muted'>Not just an app, But a whole ecosystem. Our investment  in 30+ fintech startup offer you tailored services specific to your needs.</p>
